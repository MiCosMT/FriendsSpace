    ...
    <Box sx={{ position: "relative", minHeight: "100vh" }}>
      ...
      <Container maxWidth="xl" sx={{ position: "relative", zIndex: 1 }}>
        <Stack
          ...
          sx={{ py: 4 }}
        >
          <Box sx={{ display: "flex", alignItems: "center", gap: 2, direction: { xs: "column", sm: "row" } }}>
            <Avatar
              src="/logo.png"
              variant="rounded"
        ...
        <Grid container sx={{ minHeight: "80vh" }} alignItems="center">
          <Grid item xs={12} lg={8}>
            <Box>
              ...
              >
                Conecta con personas reales que comparten tu misma energía. La
                red social donde tus intereses importan más que el scroll.
              </Typography>
        ...
        <Container maxWidth="lg">
          <Grid container spacing={3}>
            {[
              {
                title: "DESCUBRE",
                desc: "Aquí es más facil encontrar personas afines a ti.",
              ...
              <Grid item xs={12} md={4} key={index}>
                ...
                >
                  ...
                  <Typography
                    variant="h6"
                    sx={{ color: theme.primaryText, fontWeight: 900, mb: 1.5 }}
                  >
                    {item.title}
                  </Typography>
                  <Typography
                    sx={{ color: theme.secondaryText, lineHeight: 1.6 }}
                  >
                    {item.desc}
                  </Typography>
                </Card>
          ...
          >
            ...
            <Button
              ...
              to={isAuth ? undefined : "/register"}
              onClick={
                isAuth ? () => navigate("/app/searchnewfriends") : undefined
              }
              sx={{
            ...
            >
              {isAuth ? "IR A MI CUENTA" : "REGISTRARSE GRATIS"}
            </Button>
          </Box>
        </Container>
      </Box>
      ...
      <Box
        sx={{
          py: 6,
          textAlign: "center",
          borderTop: `1px solid ${theme.borderLight || accent + "10"}`,
          bgcolor: theme.primaryBack,
          position: "relative",
          zIndex: 2,
        }}
