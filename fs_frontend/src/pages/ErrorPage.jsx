...
function ErrorPage() {
  ...
  const is404 =
    error?.status === 404 || errorText.toLowerCase().includes("not found");
  ...
  return (
    <Box
      sx={{
        ...
        backgroundImage: `radial-gradient(${accent}20 1px, transparent 1px), radial-gradient(${accent}20 1px, transparent 1px)`,
    ...
    >
      ...
      >
        ...
        >
          {is404 ? "Esta página no existe" : "Algo ha salido mal"}
        </Typography>
          ...
          <Button
            ...
            sx={{
              ...
              "&:hover": {
                ...
                boxShadow: `0 7px 28px ${accent}55`,
              },
              transition: "all 0.2s",
            }}
          >
